...
bool learning_interface__msg__object_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("learning_interface.msg._object_position.ObjectPosition", full_classname_dest, 54) == 0);
  }
  learning_interface__msg__ObjectPosition * ros_message = _ros_message;
  {  // x
...
PyObject * learning_interface__msg__object_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("learning_interface.msg._object_position");
